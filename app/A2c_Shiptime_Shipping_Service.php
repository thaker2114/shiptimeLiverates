...
class A2c_Shiptime_Shipping_Service extends WC_Shipping_Method
{
	const RETRY_CNT = 3;
    ...
    unset( $package['contents'] );
		...
		} catch (A2c_Shiptime_Shipping_Exception $e) {
			update_post_meta(
	...
	private function _requestRates($data)
	{
		...
		throw new A2c_shitptime_Shipping_Exception($error_msg);
	}
